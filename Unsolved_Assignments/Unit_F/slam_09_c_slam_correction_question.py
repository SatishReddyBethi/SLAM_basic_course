...
if __name__ == '__main__':
    ...
    for i in range(len(logfile.motor_ticks)):
        ...
        f.write(f"F {kf.state[0] + scanner_displacement * cos(kf.state[2])} {kf.state[1] + scanner_displacement * sin(kf.state[2])} {kf.state[2]}")
        ...
        ellipse_data = e + (sqrt(kf.covariance[2,2]),)
        f.write(f"E {ellipse_data[0]} {ellipse_data[1]} {ellipse_data[2]} {ellipse_data[3]}")
